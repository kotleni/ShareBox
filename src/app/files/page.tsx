    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <div
                    className="w-full h-full min-h-[40px] hover:bg-muted cursor-pointer flex flex-col items-center justify-center gap-1 border rounded-lg p-4">
                    <File/>
                    henta.zip
        ...
        <div className="p-4">
            <div className="flex flex-row gap-2">
                ...
                <div className="w-full ml-auto flex flex-col items-end gap-1">
                    <span className="text-muted-foreground">Storage: 12 Mb / 100 Mb</span>
